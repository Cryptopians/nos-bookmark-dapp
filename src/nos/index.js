...
const { Provider, Consumer } = React.createContext({
  ...
  testInvoke: (scriptHash, operation, args) => nos.testInvoke(scriptHash, operation, args),
  invoke: (scriptHash, operation, args) => nos.invoke(scriptHash, operation, args),
  getStorage: (scriptHash, key, options = { encode: true }) => nos.getStorage(scriptHash, key, options)
});
